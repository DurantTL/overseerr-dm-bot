...
const RUNTIME_SETTINGS = [
  ...
  { key: 'SEASON_PACK_FORCE_GRAB', group: 'season_pack', type: 'bool', source: 'config',
    label: 'Automatically force the best eligible pack', help: 'Default off. Overrides Sonarr rejection only after the pack passes every safety limit and live duplicate/queue checks.' },
  { key: 'SEASON_PACK_MIN_SEEDERS', group: 'season_pack', type: 'int', min: 0, max: 100000, source: 'config',
    label: 'Minimum seeders for an eligible force-grab' },
  { key: 'SEASON_PACK_MAX_SIZE_GB', group: 'season_pack', type: 'int', min: 1, max: 10000, source: 'config',
    label: 'Largest pack eligible for force-grab', unit: 'GB' },
  { key: 'SEASON_PACK_MIN_CONFIDENCE', group: 'season_pack', type: 'int', min: 0, max: 100, source: 'config',
    label: 'Minimum match confidence for force-grab', unit: '%' },
