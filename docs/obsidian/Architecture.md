...
authentication/passkey, and dashboard read/mutation handlers now live in
...
| Extracted HTTP handlers | Dependency-injected health/download, tier-agent, webhook, dashboard auth, read, and mutation behavior | [src/routes](../../src/routes) |
